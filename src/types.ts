...
export interface ResearchResult {
 ...
 sold:{available:boolean;reason:string;count?:number;median?:number|null};warnings:string[];links:{ebay:string;sold:string;priceCharting?:string;web:string;ppg?:string;stockx?:string};
}
