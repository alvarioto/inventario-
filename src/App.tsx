        ...
        <div className="sheet-scroll">
          ...
          {draft.title.trim() && <section className="research-panel">
            ...
            {research ? <div className="research-result">
              ...
              <p className="source-routing-note"><b>Fuentes reales consultadas:</b> FrikiVault muestra únicamente fichas o resultados concretos que hayan participado en la identificación o valoración. LegendsVerse se usa como especialista en Marvel Legends; Coleka puede aportar catálogo/estimación general; FigureRealm se usa para confirmar identidad y variantes cuando aparece como evidencia.</p>
              <div className="source-list">{research.links.legendsVerse && <a href={research.links.legendsVerse} target="_blank" rel="noreferrer">LegendsVerse · ficha exacta</a>}<a href={research.links.ebay} target="_blank" rel="noreferrer">eBay · informativo</a><a href={research.links.sold} target="_blank" rel="noreferrer">eBay vendidos · comprobar</a>{research.links.priceCharting && <a href={research.links.priceCharting} target="_blank" rel="noreferrer">PriceCharting</a>}{research.links.stockx && <a href={research.links.stockx} target="_blank" rel="noreferrer">StockX</a>}{research.sources.filter((source) => ![research.links.legendsVerse,research.links.priceCharting].filter(Boolean).includes(source.url)).slice(0,6).map((source) => <a key={source.id} href={source.url} target="_blank" rel="noreferrer">{source.title}</a>)}</div>
